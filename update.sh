    ...
    for variant in alpine anolis; do
        ...
        (
            ...
            if [ "$variant" == "anolis" ]; then
                ...
                echo "| [postgis/postgis:${version}-${variant}](${dockerhublink}${version}-${variant}) | [Dockerfile](${githubrepolink}/${version}/${variant}/Dockerfile) | anolis:8.9 | ${postgresVersion} | ${postgisDocSrc} |" >> _dockerlists_${optimized}.md
            else
